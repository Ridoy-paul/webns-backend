    ...
    AIZ.uploader = {
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                ...
                $.post(
                    AIZ.data.appUrl + "/aiz-uploader/get_file_bysuper_ids",
                        ...
                        if (data.length > 0) {
                            ...
                            for (
                                ...
                                if (data[i].type === "image") {
                                    ...
                                    let newPath = filePath.replace('/storage/', '');
                                    thumb = '<img src="' +  AIZ.data.fileBaseUrl + newPath + '" class="img-fit">';
                                } else {
                                    thumb = '<i class="la la-file-text"></i>';
                                }
                                var html =
